...
///
/// Structure for email text field
///
public struct EmailTextField: View {
    ...
    @ObservedObject public var email: ValueTextField = ValueTextField()
    ...
    public var body: some View {
        HStack(alignment: .center,
            ...
            FloatingLabelTextField($email.value,
                                   placeholder: "type_email".localizedString(identifier: locale.identifier, bundle: Bundle.designsystem), editingChanged: { _ in
            })
...
internal struct EmailTextField_Previews: PreviewProvider {
    static var previews: some View {
        UIElementPreview(EmailTextField().environmentObject(OlaColorScheme(themeBrand: .primary)),
        ...
        UIElementPreview(EmailTextField().environmentObject(OlaColorScheme(themeBrand: .secondary)),
                         darkMode: DarkMode.none,
                         multiLanguage: false,
                         landscapeMode: false,
                         bundle: Bundle.designsystem)
